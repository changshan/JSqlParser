...
public class SmartQLEngineTest {
    ...
    public void testParseExpressionNonPartial() throws Exception {
        assertThrows(JSQLParserException.class, () -> SmartQLEngine.parseExpression("a+", false));
    ...
    public void testParseExpressionFromRaderFail() throws Exception {
        assertThrows(JSQLParserException.class, () -> SmartQLEngine.parse(new StringReader("whatever$")));
    }
    ...
    public void testParseFromStreamFail() throws Exception {
        assertThrows(JSQLParserException.class,
                () -> SmartQLEngine.parse(new ByteArrayInputStream("BLA".getBytes(StandardCharsets.UTF_8))));
    ...
    public void testParseFromStreamWithEncodingFail() throws Exception {
        assertThrows(JSQLParserException.class,
                () -> SmartQLEngine.parse(new ByteArrayInputStream("BLA".getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8.name()));
    ...
    public void testParseCondExpressionNonPartial2() throws Exception {
        assertThrows(JSQLParserException.class, () -> SmartQLEngine.parseCondExpression("x=92 lasd y=29", false));
    }
    ...
    public void testParseCondExpressionIssue471() throws Exception {
        Expression result = SmartQLEngine.parseCondExpression("(SSN,SSM) IN ('11111111111111', '22222222222222')");
    ...
    public void testParseStatementsFail() throws Exception {
        ...
        assertThrows(JSQLParserException.class, () -> SmartQLEngine.parseStatements("select * from dual;WHATEVER!!"));
    }

    @Test
    public void testParseASTFail() throws Exception {
        assertThrows(JSQLParserException.class, () -> SmartQLEngine.parseAST("select * from dual;WHATEVER!!"));
    }
    ...
    public void testParseStatementIssue1250() throws Exception {
        Statement result = SmartQLEngine.parse("Select test.* from (Select * from sch.PERSON_TABLE // root test\n) as test");
    ...
    public void testCondExpressionIssue1482() throws JSQLParserException {
        Expression expr = SmartQLEngine.parseCondExpression("test_table_enum.f1_enum IN ('TEST2'::test.test_enum)", false);
